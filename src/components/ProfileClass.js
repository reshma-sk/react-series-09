...
class profileClass extends Component {
  constructor(props) {
    ...
    this.state = {
      userInfo: {
        name: "Reshma Shaik", // default values
        bio: "Javascript | React.js", // default values
  ...
  async getUserInfo() {
    try {
      const response = await fetch(GITHUB_USER_API + GITHUB_USER_NAME);
      ...
      <div className="profile-class-container">
        ...
        <div className="repo-container">
          <h1 className="repo-title">
            Spoons & <span>Forks </span> App Repository
          </h1>
